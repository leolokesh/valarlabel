...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="bg-gray-50 text-gray-800 py-16 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-2xl shadow-lg">
        <header className="border-b pb-6 mb-8">
          ...
          <p className="mt-2 text-sm text-gray-500">Last updated: June 12, 2025</p>
        </header>

        <section className="mb-10">
          <p className="text-base leading-relaxed">
            This Privacy Policy describes how VALARLABEL (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from www.valarlabel.com (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
          </p>
        ...
        <section className="mb-10">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">What Personal Information We Collect</h3>
          ...
          <div className="space-y-6">
            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-2">Information We Collect Directly from You</h4>
              <p className="text-base leading-relaxed mb-4">Information that you directly submit to us through our Services may include:</p>
              ...
              <p className="mt-4 text-base leading-relaxed">Some features of the Services may require you to directly provide us with certain information about yourself. You may elect not to provide this information, but doing so may prevent you from using or accessing these features.</p>
            </div>

            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-2">Information We Collect about Your Usage</h4>
              <p className="text-base leading-relaxed">We may also automatically collect certain information about your interaction with the Services ("Usage Data"). To do this, we may use cookies, pixels and similar technologies ("Cookies"). Usage Data may include information about how you access and use our Site and your account, including device information, browser information, information about your network connection, your IP address and other information regarding your interaction with the Services.</p>
            </div>

            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-2">Information We Obtain from Third Parties</h4>
              <p className="text-base leading-relaxed">Finally, we may obtain information about you from third parties, including from vendors and service providers who may collect information on our behalf, such as:</p>
              ...
              <p className="mt-4 text-base leading-relaxed">Any information we obtain from third parties will be treated in accordance with this Privacy Policy. Also see the section below, Third Party Websites and Links.</p>
            </div>
          </div>
        </section>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Categories of Recipients</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Identifiers such as basic contact details and certain order and account information</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500" rowSpan={4}>
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Commercial information such as order information, shopping information and customer support information</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Internet or other similar network activity, such as Usage Data</td>
                </tr>
                 <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Geolocation data such as locations determined by an IP address or other technical measures</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <footer className="border-t pt-8 mt-10">
          ...
          <p className="text-base leading-relaxed">
            Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:lokeshvarancr@gmail.com" className="text-plum-600 hover:underline">lokeshvarancr@gmail.com</a> or contact us at 3/10D, Lakshmi Garden,, Varathayangarpalayam,Kondayampalayam(via), Coimbatore, TN, 641110, IN.
          </p>
        </footer>
      </div>
    </div>
